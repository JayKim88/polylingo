        ...
        >
          <SafeAreaView style={{ backgroundColor: colors.surface }}>
            ...
            >
              ...
              >
                <Animated.View
                  style={{ transform: [{ scale: resetButtonScale }], flex: 1 }}
                >
                  <TouchableOpacity
                ...
                <Animated.View
                  style={{ transform: [{ scale: testButtonScale }], flex: 1 }}
                >
                  <TouchableOpacity
                    className="flex-row items-center justify-center py-3 px-4 rounded-xl gap-2 border"
                    style={{
                    ...
                    disabled={isTesting}
                    onPressIn={() =>
                      !isTesting && animateButton(testButtonScale, 0.95)
                    }
                ...
                <Animated.View
                  style={{ transform: [{ scale: saveButtonScale }], flex: 1 }}
                >
                  <TouchableOpacity
